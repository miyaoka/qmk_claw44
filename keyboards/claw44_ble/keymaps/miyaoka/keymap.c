...
_______, KC_F9  , KC_F10 , KC_F11 , KC_F12 , _______,  KC_EQL , KC_1   , KC_2   , KC_3   , _______, _______,
  ...
  [L_BLE] = LAYOUT( \
  //,--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------.
     AD_WO_L ,ADV_ID1 ,ADV_ID2 ,ADV_ID3 ,ADV_ID4 ,XXXXXXX ,     _______, _______, _______, _______, _______, ENT_DFU,
  //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
     ENT_SLP ,_______ ,XXXXXXX ,XXXXXXX ,USB_DIS ,USB_EN  ,     _______, _______, _______, _______, _______, _______,
  //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
