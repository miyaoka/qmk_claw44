...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_COMMON] = LAYOUT( \
        KC_TAB , _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, KC_PSCR,
        KC_QUOT, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, KC_MINS,
        KC_LSFT, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, SFT_T(KC_KP_PLUS),
                    KC_GRV, SFT_T(KC_LBRC), _______, CK_A_EN,  CK_C_JA, LT(L_NAV, KC_ENT), SFT_T(KC_RBRC), KC_BSPC
    ),
    ...
    [L_MAC] = LAYOUT( \
        ...
        _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______,
                    _______, _______, GUI_T(KC_SPC), _______,  _______, _______, _______, _______
    ),
    ...
    [L_QWDR] = LAYOUT( \
        ...
        _______, KC_A   , KC_S   , KC_U   , KC_T   , KC_G   ,  KC_H   , KC_N   , KC_I   , KC_O   , KC_E   , _______,
    ...
    _______, _______, KC_PREV, KC_M_U , KC_NEXT, KC_HOME,  _______, KC_PGDN, KC_PGUP, KC_SPC , KC_LALT, _______,
    KC_LPRN, KC_QUES, KC_M_L , KC_M_D , KC_M_R , KC_END ,  KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT, KC_COLN, KC_RPRN,
