...
[L_NAV] = LAYOUT( \
_______, _______, KC_PREV, KC_M_U , KC_NEXT, KC_HOME,  _______, KC_PGDN, KC_PGUP, KC_SPC , KC_LALT, KC_LGUI,
KC_LPRN, KC_QUES, KC_M_L , KC_M_D , KC_M_R , KC_END ,  KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_COLN, KC_RPRN,
